...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2020 at 05:55 AM
...
('21052020001', '2020-05-21', '2020-05-23', 21);
...
(1, 'Statistika dengan Program Komputer', 10, 'Ahmad Kholiqul Amin', 'Deep Publish', 2014, '9786022809432', 5, 1, 2, 'img1557402455.jpg'),
...
(20, 'Buku Pintar Puasa Wajib dan Sunnah Sepanjang Masa', 7, 'Ali Hasan', 'Luxima', 2011, '32342342344234', 10, 0, 0, 'img1557404775.jpg'),
...
CREATE TABLE `user` (
  ...
  `image` varchar(128) NOT NULL DEFAULT 'defaulf.jpg',
...
(18, 'Jefri Sitorus', 'Bandung, Jawa Barat', 'jefrisitorus435@gmail.com', 'pro200331.jpg', '$2y$10$ueelEmER2JgNHy4IdBjXL.rDIhOenRWQQUkl0h9KuG.hQ4Iy2r9am', 2, 1, 1585215952),
(19, 'Vita Manuela', 'Jakarta, Indonesia', 'vitamanuela@gmail.com', 'pro1588610980.png', '$2y$10$TMj6dnMvr8FHGocNGJDNQOkwxHIEDGhoAeH22Vbyf13VUxhgla7Ma', 1, 1, 1585229763),
(21, 'Jhon Doe', 'Cikampek Baru', 'wanhasbullah4117@gmail.com', 'pro1590032600.jpg', '$2y$10$PYnrVTcJCx6Q/vX8bRgKm.v/M2fstmLxrBx8pqndMVycXCsDCWGn2', 2, 1, 1585462515);
