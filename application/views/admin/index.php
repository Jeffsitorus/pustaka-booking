            ...
            <div class="card border-left-success shadow h-100 py-2 bg-danger">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('pinjam'); ?>"><i class="fas fa-user-tag fa-3x text-white"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-warning shadow h-100 py-2 bg-success">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('pinjam/daftarbooking'); ?>"><i class="fas fa-shopping-cart fa-3x text-white"></i></a>
                        </div>
                    </div>
                </div>
            </div>
